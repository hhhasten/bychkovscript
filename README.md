...
*Я хз як ви знайшли цей репозиторій, але знайте що ця мова по суті повне гівно і система типізації поламана в хлам ще на самому корні ядра. І взагалі ідея писати ядро на сі шарпі це повний провал, в майбутньому я планую переписати інтерпретатор з нуля на расті і трохи змінити концепт*
